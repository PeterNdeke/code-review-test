...
class BookingRepository extends BaseRepository
{
    ...
    /**
     * Function to change timeout status
     * 
     * @param Job $job
     * @param array $data
     * @param $changedTranslator
    ...
    /**
     * Function to change started status
     * 
     * @param Job $job
     * @param array $data
     * @return bool
    ...
    /**
     * Function to change pending status
     * 
     * @param Job $job
     * @param array $data
     * @param $changedTranslator
    ...
    /**
     * Function to change withdrawal after status
     * @param Job $job
     * @param array $data
     * @return bool
     */
    ...
    /**
     * Function to change translator
     * @param object $current_translator
     * @param array $data
     * @param Job $job
     * @return array
     */
    ...
    /**
     * function to send change translator
     * 
     * @param Job $job
     * @param object $current_translator
    ...
    /**
     * Function to send change date notification
     * @param Job $job
    ...
    /**
     * Function to send changed Language notifications
     * @param Job $job
    ...
    public function getAll(Request $request, $limit = null)
    {
     ...
     /**
     * Function to send alerts for a job
     * 
     * @return array         
     */
    public function alerts()
    {
     ...
     /**
     * Function to know user login failure
     *   
     * @return array         
     */
    public function userLoginFailed()
    {
     ...
     /**
     * Function to ignore booking expired
     * 
     * @return array        
     */
    ...
    /**
     * Function to ignore Expiring jobs
     * 
     * @param  int $id   
     * @return string         
     */
    ...
    /**
     * Function to ignore Expired jobs
     * 
     * @param  int $id   
     * @return string         
     */
